          ...
          <div className={css.content}>
            <motion.div variants={textVariant2} className={css.card}>
              <div className={css.info}>
                ...
                <p>
                  ...
                  team of experts will work closely with you to design and build
                  a pool that meets your unique needs and exceeds your
                  expectations.
                </p>
              </div>
            ...
            <motion.div variants={textVariant2} className={css.card}>
              <div className={css.info}>
                ...
                <p>
                  Our pool excavation services are designed to help you create
                  the perfect foundation for your pool. We use the latest
                  excavation techniques and equipment to ensure precision and
                  accuracy, and we take great care to minimize disruption to
                  your property. Whether you need a new pool excavation or
                  repairs to an existing pool, we have the expertise and
                  resources to get the job done right.
                </p>
                <span>
                  Contact us today to learn more about our services and how we
                  can help you create the pool of your dreams.
                </span>
              </div>
              <div className={css.image}>
